(function(){
  ...
  function buildChart1(){
    ...
    Plotly.newPlot('ch1',[
      ...
      annotations:ex.map(function(v,i){
        return{x:v,y:ey[i]+(i===0?32:20),xref:'x',yref:'y',text:'<b>'+v+'</b>',showarrow:false,
          font:{size:11,color:ec[i],family:monoFont},yanchor:'bottom'};
      })
  ...
  function buildChart2(){
    ...
    Plotly.newPlot('ch2',[{
      ...
      line:{color:'#1565a0',width:2.5,shape:'spline'},
      marker:{
        color:x2.map(function(v){return v==='1999-09-27'?'#8b2020':'#1565a0';}),
      ...
      yaxis:{showgrid:true,gridcolor:'rgba(20,18,10,.07)',zeroline:false,tickprefix:'$',ticksuffix:'/oz',
             tickfont:{size:10,color:'#a09e96',family:monoFont},range:[230,360]},
      shapes:[{type:'rect',x0:'1999-09-24',x1:'1999-10-05',y0:0,y1:1,
               xref:'x',yref:'paper',fillcolor:'rgba(139,32,32,.1)',
